...
// Title Screen HTML Interface DOM Selectors
const titleScreen = document.getElementById("title-screen");
const menuLogo = document.getElementById("menu-logo");
const menuSubtitle = document.getElementById("menu-subtitle");
const startBtn = document.getElementById("start-btn");
const guideBlock = document.querySelector(".controls-guide");
...
let gameStartedFirstTick = false; 
...
function updateGame() {
    if (gameState === "playing") {
        ...
        // Fixed index reading to safely check collisions
        if (gameStartedFirstTick && hasGameEnded()) {
            gameState = "gameover";
            if (score > highScore) {
                highScore = score;
...
// Core Rendering Loop (60 FPS Graphics Rendering)
...
function moveSnake() {
    // FIXED: Adjusted from snake.x to snake[0].x to pull array variables properly
...
function showGameOverOverlay() {
    if (!menuLogo || !menuSubtitle || !startBtn) return;
    
    menuLogo.innerText = "GAME OVER";
    menuLogo.style.color = "#ff00ff";
    menuLogo.style.textShadow = "0 0 10px #ff00ff, 0 0 20px #ff00ff";
    
    menuSubtitle.innerText = "Final Score: " + score;
    menuSubtitle.style.color = "#00ffff";
    menuSubtitle.style.textShadow = "0 0 5px #00ffff";
    
    if (guideBlock) guideBlock.style.display = "none"; 
    startBtn.innerText = "PRESS SPACE TO RESTART";
}
...
function hasGameEnded() {
    // FIXED: Adjusted to snake[0] index to read array array loops accurately
...
function resetGame() {
    ...
    score = 0;
    eatFlashTimer = 0;
    gameStartedFirstTick = false; 
    
    if (menuLogo) {
        menuLogo.innerText = "Snaik";
        menuLogo.style.color = "#00ffff";
        menuLogo.style.textShadow = "0 0 10px #00ffff, 0 0 20px #00ffff";
    }
    if (menuSubtitle) {
        menuSubtitle.innerText = "by HypnoLaser";
        menuSubtitle.style.color = "#ff00ff";
        menuSubtitle.style.textShadow = "0 0 5px #ff00ff";
    }
    if (guideBlock) guideBlock.style.display = "block";
    if (startBtn) startBtn.innerText = "PRESS SPACE TO PLAY";
